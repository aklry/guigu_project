<template>
  <div>
    <el-card class="box-card">
      <!-- 卡片顶部添加品牌按钮 -->
      <el-button type="primary" icon="Plus" @click="addTrademarkHandle">添加品牌</el-button>
      <!-- 表格数据,用于展示已有品牌数据 -->
      <el-table :data="trademarkArr" style="margin: 10px 0" border>
        ...
        <el-table-column label="品牌操作">
          <template #="{ row, $index }">
            <el-button type="primary" size="small" icon="Edit" @click="editTrademarkHandle" />
    ...
    -->
      <el-pagination v-model:current-page="currentPage" v-model:page-size="pageSize" :page-sizes="pageSizes"
        layout="prev, pager, next, jumper, ->, total, sizes, " @current-change="getHasTradeMark"
        @size-change="pageSizeChange" :total="total" />
    </el-card>
    <!-- 对话框组件：用于添加品牌与修改品牌 -->
